...
uniform sampler2D inputImageTextureMask1;
uniform sampler2D inputImageTextureMask2;
uniform sampler2D inputImageTextureMask3;
...
void main()
{
  ...
  const float _w = 0.9;
  float w1=0.0, w2=1.05, w3=0.66, w4=0.5;
