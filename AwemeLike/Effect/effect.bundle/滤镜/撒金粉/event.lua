    ...
    handleEffectEvent = function (this, eventCode)
        if (eventCode == 1 and init_state == 1) then
            ...
            if(1.0*display_height/display_width > 889.0/500.0 ) then
                Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname9490104AEA3C4249952D38A82BC2E18A", "clipname1_heightAlign", 0)
            else
                Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname9490104AEA3C4249952D38A82BC2E18A", "clipname1_widthAlign", 0)
            end
            -- Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname9490104AEA3C4249952D38A82BC2E18A", "clipname1", 0)
        end
        return true
    end,
    }
