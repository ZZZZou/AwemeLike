        ...
        if (eventCode == 1 and init_state == 1) then
            ...
            local effectManager = this:getEffectManager()
                ...
                if(1.0*display_height/display_width > 889.0/500.0 ) then
                    Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname7C9FD73373094DAB8E8354272A8F95EB", "clipname1_heightAlign", 0)
                else
                    Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname7C9FD73373094DAB8E8354272A8F95EB", "clipname1_widthAlign", 0)
                end
            -- Sticker2DV3.playClip(this, "2DStickerV3_5100", "entityname7C9FD73373094DAB8E8354272A8F95EB", "clipname1", 0)
        end
        return true
    end,
    }
